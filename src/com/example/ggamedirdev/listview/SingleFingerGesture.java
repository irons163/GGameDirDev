...
public class SingleFingerGesture {
     ...
     */
    @Deprecated
    public SingleFingerGesture(OnGestureListener listener, Handler handler) {
     ...
     */
    @Deprecated
    public SingleFingerGesture(OnGestureListener listener) {
     ...
     * @throws NullPointerException if {@code listener} is null.
     */
    public SingleFingerGesture(Context context, OnGestureListener listener) {
     ...
     * @throws NullPointerException if {@code listener} is null.
     */
    public SingleFingerGesture(Context context, OnGestureListener listener, Handler handler) {
        if (handler != null) {
...
//        }
        ...
        float sumX = 0, sumY = 0;
        int count = 1;
        float focusX = sumX = ev.getX();
        float focusY = sumY = ev.getY();
        ...
        case MotionEvent.ACTION_MOVE:
        	if(!isEnableMultiTouch && !mStillDown)
        		break;
